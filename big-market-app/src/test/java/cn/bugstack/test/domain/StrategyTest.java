...
public class StrategyTest {
    ...
    public void test_getAssembleRandomVal_RuleWeight(){
        log.info("测试结果：{} - 奖品ID值", strategyDispatch.getRandomAwardId(100001L,"4000:102,103,104,105"));
        log.info("测试结果：{} - 奖品ID值", strategyDispatch.getRandomAwardId(100001L,"5000:102,103,104,105,106,107"));
        log.info("测试结果：{} - 奖品ID值", strategyDispatch.getRandomAwardId(100001L,"6000:102,103,104,105,106,107,108,109"));
